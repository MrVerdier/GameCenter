...
foreach( $aRows as $jRow){
    echo "
    <div class='image'>
        <img class='image-cover' data-image='$jRow->url' src='imgs/showroom/$jRow->url' alt=''>
        <div class='delete-button' onclick='deleteFromShowroomConfirm(this)'><i class='fas fa-trash'></i></div>
    </div>
";}
