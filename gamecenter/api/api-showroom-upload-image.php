...
$target_dir = __DIR__."/../imgs/showroom/";
...
if ($uploadOk == 0) {
    ...
    <a href='../showroom.php' class='upload-more' style='color: #C80000;'>Click here to try again</a>";
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_dir.$imageID.'.'.$imageFileType)) {  
        ...
        $stmt = $db->prepare('INSERT INTO images (title, url, user_fk) VALUES("testimage", :name, :userId)');
